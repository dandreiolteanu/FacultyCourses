...
void printMenu()
{
    ...
    printf("🔵 Press '2' to list all Estates.\n");
    printf("🔵 Press '3' to remove an Estate.\n");
    printf("🔵 Press '4' to update an Estate.\n");
    printf("🔵 Press '5' to list estates with {address} combination.(BONUS/MENU)\n");
    printf("🔵 Press '6' to filter by type and surface greater than.\n");
    printf("🔵 Press '7' to filter by price.(BONUS)\n");
    printf("🔴 HIT ->'7' to undo (Coming 🔜...)\n");
    printf("🔴 HIT ->'8' to redo (Coming 🔜...)\n");
